              ...
              <li>
                ...
                <ul class="menu inner-content-div">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo site_Url(); ?>assets/admin/images/user2-160x160.jpg" class="rounded-circle" alt="User Image">
                      </div>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo site_Url(); ?>assets/admin/images/user3-128x128.jpg" class="rounded-circle" alt="User Image">
                      </div>
                      <div class="mail-contnet">
                         <h4>
                          Nullam tempor
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo site_Url(); ?>assets/admin/images/user4-128x128.jpg" class="rounded-circle" alt="User Image">
                      </div>
                      <div class="mail-contnet">
                         <h4>
                          Proin venenatis
...
<?php /*
		 <!-- User Account: style can be found in dropdown.less -->
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo site_Url(); ?>assets/admin/images/user5-128x128.jpg" class="user-image rounded-circle" alt="User Image">
            </a>
            <ul class="dropdown-menu scale-up">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo site_Url(); ?>assets/admin/images/user5-128x128.jpg" class="float-left rounded-circle" alt="User Image">
                <p>
                  <?php echo $_SESSION['users.name_first'].' '.$_SESSION['users.name_last']; ?>
                  <small class="mb-5"><?php echo $_SESSION['users.email']; ?></small>
              ...
              <li class="user-body">
				...
				<div role="separator" class="divider col-12"></div>
				  <div class="col-12 text-left">
                    <a href="<?php echo site_Url(); ?>login/view.php?logout"><i class="fa fa-power-off"></i> Logout</a>
                  </div>				
                </div>
                <!-- /.row -->
              </li>
